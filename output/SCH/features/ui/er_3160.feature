@Team-SCH @ui @mode:serial @feature @P3-Medium @Regression @GA @group-P2PLGTest @ER-3160
Feature: Ability to prioritize and optimize (spread) Full Time employees when scheduling
