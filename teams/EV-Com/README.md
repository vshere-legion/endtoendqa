...
## Quick Start
```bash
# Run all EV-Com tests on dev
TEST_TEAM=EV-Com TEST_ENV=dev npm run test

# Run P1 regression on UAT
TEST_TEAM=EV-Com TEST_ENV=uat TEST_TAGS="@P1-Critical and @Regression" npm run test
```

## Tagging Checklist
- [ ] `@Team-EV-Com` at Feature level
