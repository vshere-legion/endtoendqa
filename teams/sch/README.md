...
## Quick Start
```bash
# Run all SCH tests on dev
TEST_TEAM=SCH TEST_ENV=dev npm run test

# Run P1 regression on UAT
TEST_TEAM=SCH TEST_ENV=uat TEST_TAGS="@P1-Critical and @Regression" npm run test
```

## Tagging Checklist
- [ ] `@Team-SCH` at Feature level
